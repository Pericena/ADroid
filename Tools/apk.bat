...
IF EXIST "%~dp0place-apk-user\%~n1.apk" (
...
%szip% a -tzip "%~dp0place-apk-user\%~n1.apk" "%~dp0themeport_otemp_%~n1\*" -mx9 -mmt *.png > nul
...
cd place-apk-user
powercfg /energy
rem C:\WINDOWS\system32\energy-report.html
powercfg /batteryreport
rem C:\Windows\System32\battery-report.html
powercfg /LIST
:end
exit
